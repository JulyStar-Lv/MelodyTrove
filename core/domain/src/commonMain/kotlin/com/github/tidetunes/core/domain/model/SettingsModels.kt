...
data class LyricFontSettings(
    val westernFont: LyricFontChoice = LyricFontChoice.TideSans,
    val cjkFont: LyricFontChoice = LyricFontChoice.TideCjk,
...
data class SettingsBackupSettings(
    ...
    val remoteDirectory: String = "/TideTunes/Backups",
) {
    companion object {
