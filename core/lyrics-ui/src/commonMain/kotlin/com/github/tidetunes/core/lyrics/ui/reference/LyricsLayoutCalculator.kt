...
import com.github.tidetunes.core.lyrics.ui.reference.isArabic
import com.github.tidetunes.core.lyrics.ui.reference.isDevanagari
import com.github.tidetunes.core.lyrics.ui.reference.isPunctuation
import com.github.tidetunes.core.lyrics.ui.reference.isPureCjk
...
fun measureSyllablesAndDetermineAnimation(
    ...
    return words.flatMapIndexed { wordIndex, word ->
        ...
        val useAwesomeAnimation =
            perCharDuration > textAnimationSpec.fastCharacterThresholdMs &&
                wordDuration >= textAnimationSpec.advancedWordMinDurationMs
...
fun calculateStaticLineLayout(
    ...
    val positionedLines = wrappedLines.mapIndexed { lineIndex, wrappedLine ->
        ...
        val startX = when (textAlign) {
            ...
            TextAlign.End, TextAlign.Right -> canvasWidth - wrappedLine.totalWidth
            else -> 0f
        }
