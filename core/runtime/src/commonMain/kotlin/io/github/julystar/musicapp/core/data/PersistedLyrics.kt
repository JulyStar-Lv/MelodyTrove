...
fun LyricsEntity.toPlaybackLyrics(): Lyrics {
...
fun List<LyricsEntity>.selectLyrics(settings: LyricDisplaySettings): LyricsEntity? {
...
fun LyricsEntity.resolvedSourceKind(): LyricSourceKind =
    run {
...
fun List<LyricsEntity>.shouldLookupPreferredExternalLyrics(
