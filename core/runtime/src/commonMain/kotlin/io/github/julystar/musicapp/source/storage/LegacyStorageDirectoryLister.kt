...
fun SourceAccountId.toLegacyStorageIdOrNull(): StorageId? {
    return toStorageRouteIdOrNull()?.let(::StorageId)
}

fun StorageId.toLegacyStorageSourceAccountId(): SourceAccountId {
    return storageSourceAccountId(value)
}

fun LegacyStorageKind.toStorageType(): StorageType {
    return when (this) {
...
fun ListStorageEntryChildrenResp.toSourceListResult(
