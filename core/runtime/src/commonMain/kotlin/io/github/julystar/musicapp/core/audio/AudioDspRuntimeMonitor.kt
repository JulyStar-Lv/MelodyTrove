...
const val AUDIO_DSP_DIAGNOSTICS_INTERVAL_MS = 150L
const val AUDIO_REACTIVE_VISUALIZATION_INTERVAL_MS = 33L
...
object AudioDspRuntimeMonitor : AudioDspRuntimeRepository {
    ...
    val monitoringRequesters = mutableMonitoringRequesters.asStateFlow()
...
fun Flow<Set<AudioMonitoringRequester>>.monitoringRequested(
