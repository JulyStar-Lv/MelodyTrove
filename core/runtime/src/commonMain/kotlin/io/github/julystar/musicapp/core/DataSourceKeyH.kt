...
fun DataSourceKey.toArtwork(): Artwork {
    return when (this) {
        is DataSourceKey.Music -> Artwork.LibraryTrack(id.value)
        is DataSourceKey.Cover -> Artwork.LibraryCover(id.value)
        is DataSourceKey.AnyEntry -> Artwork.LegacyStorageEntry(
