    ...
    companion object {
        val HOST_BOOTSTRAP = """
            (function(g){
              ...
              function body(url,b,x){x=o(x);var contentType=x.contentType||'application/json; charset=utf-8';return {url:String(url||''),body:b==null?'':String(b),bodyBase64:x.bodyBase64,bodyBytes:x.bodyBytes,contentType:contentType,headers:withContentType(x.headers,contentType),connectTimeoutMs:x.connectTimeoutMs,readTimeoutMs:x.readTimeoutMs,followRedirects:x.followRedirects}}
