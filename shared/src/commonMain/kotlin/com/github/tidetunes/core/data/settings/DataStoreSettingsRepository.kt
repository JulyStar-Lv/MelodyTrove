...
import com.github.tidetunes.core.domain.model.SettingsBackupSelection
import com.github.tidetunes.core.domain.model.SettingsBackupSettings
import com.github.tidetunes.core.domain.model.normalizeAudioEffectSettings
...
import com.github.tidetunes.core.domain.model.normalizeLyricFontScalePercent
import com.github.tidetunes.core.domain.model.normalizeLyricFontSettings
import com.github.tidetunes.core.domain.model.normalizeLyricLineBlacklist
import com.github.tidetunes.core.domain.model.normalizeLyricPerspectiveAngleDegrees
import com.github.tidetunes.core.domain.model.normalizeLyricPrimaryFontSizeSp
import com.github.tidetunes.core.domain.model.normalizeLyricSecondaryFontSizeSp
import com.github.tidetunes.core.domain.model.normalizeLyricSourcePriority
...
import com.github.tidetunes.core.domain.model.normalizePlaybackAdvancedSettings
                ...
                font = normalizeLyricFontSettings(
                    LyricFontSettings(
                        westernFont = preferences[LYRIC_WESTERN_FONT_KEY]
                            .enumOrDefault(LyricFontChoice.TideSans),
                        cjkFont = preferences[LYRIC_CJK_FONT_KEY]
                            .enumOrDefault(LyricFontChoice.TideCjk),
