...
import com.github.tidetune.database.PlaylistEntity
import com.github.tidetune.database.PlaylistSummaryRow
import com.github.tidetune.database.PlaylistTrackCrossRef
import com.github.tidetune.database.PlaylistTrackRow
...
import com.github.tidetune.domain.importing.normalizeRemotePath
import com.github.tidetune.domain.importing.stableTrackId
...
class RoomLibraryStore(
    ...
    private suspend fun resolveTrackLoc(track: TrackEntity): StorageEntryLoc? {
        ...
        if (sourceStorageId != null && sourcePath != null) {
            return StorageEntryLoc(storageId = uniffi.tidetune_core.StorageId(sourceStorageId), path = sourcePath)
        }
        ...
        return StorageEntryLoc(
            storageId = uniffi.tidetune_core.StorageId(remoteFile.storageId),
    ...
    private fun PlaylistEntity.toPlaylistAbstract(
        ...
        val coverLoc = coverPath?.let { path ->
            ...
            StorageEntryLoc(uniffi.tidetune_core.StorageId(storageId), path)
        }
