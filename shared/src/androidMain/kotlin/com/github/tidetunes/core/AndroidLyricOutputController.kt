...
internal class AndroidLyricOutputController(
            ...
            runCatching {
                lyricon = LyriconFactory.createProvider(
                    ...
                    logo = ProviderLogo.fromDrawable(
                        context,
                        com.github.tidetunes.shared.R.drawable.icon_lyrics,
                        width = 96,
                        height = 96,
                    ),
                ).also { it.register() }
    ...
    private fun TextView.applyFloatingFont(text: String) {
        ...
        val base = when (choice) {
            ...
            LyricFontChoice.TideSans -> Typeface.create("sans-serif", Typeface.NORMAL)
            LyricFontChoice.TideCjk -> Typeface.create("sans-serif", Typeface.NORMAL)
