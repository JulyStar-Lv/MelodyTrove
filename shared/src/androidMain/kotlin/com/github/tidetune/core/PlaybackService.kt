package com.github.tidetune.core
...
class PlaybackService : MediaSessionService() {
    ...
    override fun onCreate() {
        super.onCreate()
        tidetuneLog("Playback service creating...")
        val context = this

        val intent = Intent(this, Class.forName("com.github.tidetune.MainActivity")).apply {
        ...
        val player = ExoPlayer.Builder(context)
            ...
            .setMediaSourceFactory(ProgressiveMediaSource.Factory(DataSource.Factory { MusicPlayerDataSource(assetRepository, serviceScope) }) )
            .build()
        ...
        tidetuneLog("Playback service created")
        ...
        serviceScope.launch(Dispatchers.Main) {
            playerRepository.pauseRequest.collect {
                ...
                if (player.isCommandAvailable(COMMAND_PLAY_PAUSE)) {
                    ...
                    tidetuneError("media player pause failed, command COMMAND_PLAY_PAUSE is unavailable")
                }
            }
        }
    }
