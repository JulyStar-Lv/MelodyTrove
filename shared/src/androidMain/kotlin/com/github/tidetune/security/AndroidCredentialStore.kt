...
private const val KEY_ALIAS = "TideTuneCredentialKey"
private const val PREFERENCES = "tidetune_secure_credentials"
...
private class AndroidCredentialStore : CredentialStore {
    ...
    override suspend fun delete(storageId: Long) {
        preferences.edit().remove(storageId.toString()).apply()
    }
