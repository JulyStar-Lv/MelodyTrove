...
pub struct ParseOptions {
	...
	pub(crate) read_cover_art_presence: bool,
...
impl ParseOptions {
	...
	/// Whether to retain an empty picture marker when cover art data is skipped.
	///
	/// This allows callers to detect embedded artwork without loading its payload.
	pub fn read_cover_art_presence(&mut self, read_cover_art_presence: bool) -> Self {
		self.read_cover_art_presence = read_cover_art_presence;
		*self
	}
