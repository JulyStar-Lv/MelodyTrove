...
const ONEDRIVE_REDIRECT_URI: &str = "tidetune://oauth2redirect/";
...
async fn refresh_token_by_code_impl(
    ...
    let client_id = TIDETUNE_ONEDRIVE_ID;
    let body = [
        ("client_id", client_id),
...
mod tests {
    ...
    fn parses_drive_list_and_owner() {
                ...
                "value": [
                    {
                        ...
                        "driveType": "business",
                        "owner": {
                            "user": { "displayName": "TideTune Tester" }
                        }
                    }
                ],
        ...
        assert_eq!(drives[0].owner_name.as_deref(), Some("TideTune Tester"));
