# TideTunes — Komi Store Architecture Refactor Task Tracking
...
- [x] Active Presentation Kotlin source uses Miuix, TideTunes App components, and Compose runtime/UI/foundation/animation/resources instead of Compose Material or Material3.
- [x] `TideTunesTheme`, core App components, app shell, navigation bars, sidebar, MiniPlayer, Now Playing, and toast/snackbar UI migrated off Material APIs.
