...
existing repositories and controller. Visual QA compares structure and the
profile metric contract; device screenshots remain supplemental because the
Android Automotive emulator image does not render every physical display
reliably in headless capture.
...
| `3:384`, `89:845`, `1879:1516`, `1879:2469` | 2496×1080 / 1728×1080 | Songs, dark/light | `screen/CarLibraryScreens.kt` | Expanded / VehiclePanel | PASS | PASS: complete list and playing state |
...
| `970:776`, `970:1777`, `1879:1909`, `1879:2862` | 2496×1080 / 1728×1080 | Playlists, dark/light | `screen/CarLibraryScreens.kt` | Expanded / VehiclePanel | PASS | PASS: empty/content/focus states |
...
| `1:65`, `89:566`, `1886:2376`, `1886:2808` | 2496×1080 / 1728×1080 | Now Playing, dark/light | `nowplaying/CarNowPlayingScreen.kt` | Expanded / VehiclePanel | PASS | PASS: 1000/1328 and 660/848 panes |
...
| `1480:1130` (`1480:1131` content) | 5120×1440 (5120×1304 content) | Minimal Now Playing | `nowplaying/CarFullscreenNowPlayingScreen.kt` | FullscreenCockpit | PASS | PASS: shell-free structural layout and 720 artwork |
| `1524:1130` | 5120×1440 | Cover Flow | `nowplaying/CarFullscreenNowPlayingScreen.kt` | FullscreenCockpit | PASS | PASS: shell-free five-item queue flow |
