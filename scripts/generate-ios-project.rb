...
project_path = File.join(ios_app_dir, "TideTune.xcodeproj")
...
target = project.new_target(:application, "TideTune", :ios, "16.0")
target.product_reference.name = "TideTune.app"

app_group = project.main_group.new_group("TideTune")
swift_file = app_group.new_file("TideTuneApp.swift")
...
target.build_configurations.each do |configuration|
  ...
  settings["OTHER_LDFLAGS"] = ["$(inherited)", "-framework", "TideTuneShared"]
  settings["PRODUCT_BUNDLE_IDENTIFIER"] = "com.github.tidetune"
  settings["PRODUCT_NAME"] = "TideTune"
...
scheme.save_as(project_path, "TideTune", true)
